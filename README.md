...
```swift
.package(url: "https://github.com/superuser404notfound/AetherEngine", from: "4.5.0")
```
...
Pin to `.upToNextMinor(from: "4.5.0")` for stricter teams that prefer to opt into minor bumps explicitly.
